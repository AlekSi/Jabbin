...
/**
 * If there is active jabbin.com account, returns it. Otherwise returns first
 * non-active jabbin.com account. Otherwise returns zero.
 */
...
/**
 * Returns a list of all enabled non-jabbin.com accounts. Active are placed on
 * top of the list.
 */
