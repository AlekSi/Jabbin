...
#ifndef YACONTACTLISTFRIENDSMODEL_H
#define YACONTACTLISTFRIENDSMODEL_H
...
class YaContactListFriendsModel : public YaContactListModel
{
	Q_OBJECT
public:
	YaContactListFriendsModel(PsiContactList* contactList);
