...
public:
	...
	QStringList hiddenCalls(const Jid &) const;
	...
	static void getErrorInfo(int err, AdvancedConnector *conn, Stream *stream, QCATLSHandler *tlsHandler, QString *_str, bool *_reconn, bool *_disableAutoConnect);
...
public slots:
...
#ifdef YAPSI
	void dj_authInternal(const Jid &);
#endif
	...
	void actionMakeCall(const Jid &);
	void actionPhoneCall();
