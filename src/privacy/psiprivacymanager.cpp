...
PsiPrivacyManager::PsiPrivacyManager(XMPP::Task* rootTask)
	: rootTask_(rootTask)
...
{
	SetPrivacyListsTask *t = dynamic_cast<SetPrivacyListsTask*>(sender());
	if (!t) {
...
{
	GetPrivacyListsTask *t = dynamic_cast<GetPrivacyListsTask*>(sender());
	if (!t) {
...
{
	GetPrivacyListTask *t = dynamic_cast<GetPrivacyListTask*>(sender());
	if (!t) {
